...
public class HotelReservation {
    ...
    ArrayList<Integer> bookingrooms = new ArrayList<Integer>();
    ...
    void AddingReservation(){
        ...
        if (isBookedRoom(selectRoom.getRoomNumber(),start,end)) {
            ...
            bookingrooms.add(selectRoom.getRoomNumber());
...
// Catch invalid input and return early
    ...
    private boolean isBookedRoom(int roomNo, int start,int end){
        if(!bookingrooms.contains(roomNo)){
            return true;
        }
